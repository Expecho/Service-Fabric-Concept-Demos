...
{
    [EventSource(Name = "MyCompany-DynamicEventSourceDemo-DemoService-Original")]
    internal sealed class OriginalServiceEventSource : EventSource
    {
        public static readonly OriginalServiceEventSource Current = new OriginalServiceEventSource();

        static OriginalServiceEventSource()
        {
        ...
        private OriginalServiceEventSource()
        { }
